...
class MQ():
    ...
    def MQPercentage(self):
        ...
        #print("MQPercentage is returning ")
        #print val
        return val
    ...
    def MQResistanceCalculation(self, raw_adc):
        #print("Running MQResistanceCalculation")
        #print("The RAW ADC value is: ")
        print (raw_adc)
    
        MQRreturn = float(self.RL_VALUE*(1023.0-raw_adc)/float(raw_adc));
        #print("The MQRreturn value is: ")
        #print MQRreturn
        return MQRreturn
    ...
    def MQCalibration(self, mq_pin):
        ...
        #print("Returning from MQCalibration")
    ...
    def getRaw(self, mq_pin):
    
        #print("Running MQCalibration")
        val = 0.0

        val = self.adc.read(mq_pin)
    ...
    def MQGetGasPercentage(self, rs_ro_ratio, gas_id):
        ...
        #print("Running MQGetGasPercentage")
        ...
        #print("Returning 0 from MQGetGasPercentage")
        return 0
    ...
    def MQGetPercentage(self, rs_ro_ratio, pcurve):
        ...
        #print("Running MQGetPercentage")
        #print(rs_ro_ratio)
        
        #print("Returning form MQGetPercentage with the value ")
        #print pcurve
        return pcurve
